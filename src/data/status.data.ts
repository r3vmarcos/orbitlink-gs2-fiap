...
export const statusData: StatusOrbital[] = [
  {
    ...
    texto: 'Visual simulado da Terra vista da órbita. Na versão com API, esta área recebe imagem EPIC/NASA com fallback visual.',
    tipo: 'camera_orbital',
  ...
  },
  {
    ...
    texto: 'Status 24h da colônia lunar com atualização do módulo solar e registro visual da superfície da Lua.',
    tipo: 'missao',
  ...
  },
  {
    ...
    texto: 'Relato comunitário ativo por 24h para o mark Amazônia, conectando floresta, clima e monitoramento orbital.',
    tipo: 'alerta',
