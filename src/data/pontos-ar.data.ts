...
const pontosCeu: EntradaPontoAr[] = [
  ...
  ['selene', 'Colonia Lunar Selene', 'colonia_lunar', ['lua', 'missoes', 'social'], 17, 22, true],
  ...
  ['jupiter', 'Jupiter', 'planeta', ['planetas', 'eventos'], 55, 24],
  ['saturno', 'Saturno', 'planeta', ['planetas'], 66, 16],
  ['mercurio', 'Mercurio', 'planeta', ['planetas'], 74, 30],
  ['netuno', 'Netuno', 'planeta', ['planetas'], 84, 19],
  ['urano', 'Urano', 'planeta', ['planetas'], 94, 33],
  ['aurora', 'Estacao Orbital Aurora', 'estacao_espacial', ['estacoes', 'social', 'missoes'], 4, 44, true],
  ...
  ['gaia13', 'Satelite Gaia-13', 'satelite', ['satelites', 'clima', 'missoes'], 33, 52, true],
  ...
  ['starlink_01', 'Constelacao Starlink 01', 'satelite', ['satelites', 'social'], 73, 47],
  ...
  ['orion_nebula', 'Nebulosa de Orion', 'evento_astronomico', ['eventos'], 30, 65],
  ...
  ['pleiades', 'Pleiades', 'evento_astronomico', ['eventos'], 60, 80],
  ...
  ['observatorio_solar', 'Observatorio Solar', 'satelite', ['satelites', 'clima'], 46, 88],
  ['anel_saturno', 'Aneis de Saturno', 'planeta', ['planetas', 'eventos'], 56, 59],
  ['janela_lunar', 'Janela Lunar', 'lua', ['lua', 'eventos'], 66, 72],
  ['rota_artemis', 'Rota Artemis', 'evento_astronomico', ['lua', 'missoes'], 76, 57],
  ['constelacao_ods', 'Constelacao ODS', 'evento_astronomico', ['ods', 'social'], 86, 82],
...
const pontosTerra: EntradaPontoAr[] = [
  ...
  { id: 'amazonia', nome: 'Amazonia', tipo: 'bioma', perspectiva: 'espaco', camada: ['biomas', 'clima', 'ods', 'social'], x: 42, y: 48, latitude: -3.4653, longitude: -62.2159, statusAtivo: true, nivelAlerta: 'medio', ods: ['ODS 13', 'ODS 2'] },
  { id: 'sao_paulo', nome: 'Sao Paulo', tipo: 'cidade', perspectiva: 'espaco', camada: ['cidades', 'social', 'ods'], x: 50, y: 65, latitude: -23.5505, longitude: -46.6333, ods: ['ODS 11'] },
  ...
  { id: 'alerta_atlantico', nome: 'Alerta Atlantico Sul', tipo: 'alerta_ambiental', perspectiva: 'espaco', camada: ['clima', 'ods'], x: 38, y: 72, latitude: -32, longitude: -35, nivelAlerta: 'alto', ods: ['ODS 13'] },
  ...
  { id: 'pacifico', nome: 'Oceano Pacifico', tipo: 'oceano', perspectiva: 'espaco', camada: ['clima', 'ods'], x: 95, y: 74, latitude: -8.7832, longitude: -124.5085, nivelAlerta: 'baixo', ods: ['ODS 13'] },
  ...
  { id: 'mata_atlantica', nome: 'Mata Atlantica', tipo: 'bioma', perspectiva: 'espaco', camada: ['biomas', 'clima', 'ods'], x: 56, y: 70, latitude: -20.3, longitude: -42.8, ods: ['ODS 13'] },
  ...
  { id: 'galapagos', nome: 'Galapagos', tipo: 'bioma', perspectiva: 'espaco', camada: ['biomas', 'clima', 'turismo'], x: 28, y: 64, latitude: -0.9538, longitude: -90.9656, ods: ['ODS 13'] },
  { id: 'antartida', nome: 'Antartida', tipo: 'bioma', perspectiva: 'espaco', camada: ['biomas', 'clima', 'ods'], x: 52, y: 94, latitude: -82.8628, longitude: 135, nivelAlerta: 'alto', ods: ['ODS 13'] },
  { id: 'groenlandia', nome: 'Groenlandia', tipo: 'bioma', perspectiva: 'espaco', camada: ['biomas', 'clima'], x: 37, y: 16, latitude: 71.7069, longitude: -42.6043, ods: ['ODS 13'] },
  { id: 'mediterraneo', nome: 'Mediterraneo', tipo: 'oceano', perspectiva: 'espaco', camada: ['clima', 'turismo'], x: 56, y: 41, latitude: 35, longitude: 18, ods: ['ODS 13'] },
  { id: 'indico', nome: 'Oceano Indico', tipo: 'oceano', perspectiva: 'espaco', camada: ['clima', 'ods'], x: 70, y: 68, latitude: -20, longitude: 80, ods: ['ODS 13'] },
...
function criarPonto(entrada: EntradaPontoAr): PontoAr {
  ...
  return {
    ...entrada,
    titulo: entrada.perspectiva === 'terra' ? `${entrada.nome} no ceu` : `${entrada.nome} visto da orbita`,
    descricao: entrada.perspectiva === 'terra'
      ? `Mark celeste da camada ${camadaPrincipal} distribuido no ceu 360 da Orbitlink.`
      : `Mark terrestre da camada ${camadaPrincipal} para leitura em mapa e visao espacial.`,
    dadosResumo: [
      `Camada: ${entrada.camada.join(', ')}`,
      `Perspectiva: ${entrada.perspectiva === 'terra' ? 'AR Terra' : 'MAPA Espaco'}`,
      `Posts vinculados: 1`,
    ],
