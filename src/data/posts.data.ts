...
export const postsData: PostOrbitLink[] = pontosArData.map((ponto, indice) => {
  ...
  return {
    ...
    texto: `Publicacao vinculada ao mark ${ponto.nome}, na camada ${camadaPrincipal}. O registro aparece no ${local} com contexto, fotos e status para a simulacao Orbitlink.`,
